...
#ifndef GOOGLE_PROTOBUF_INCLUDED_capability_2fv1_2fcapability_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_capability_2fv1_2fcapability_2eproto_2epb_2eh
...
#define PROTOBUF_INTERNAL_EXPORT_capability_2fv1_2fcapability_2eproto
...
struct TableStruct_capability_2fv1_2fcapability_2eproto {
...
PROTOBUF_NAMESPACE_OPEN
template <>
::capability::v1::Capability* Arena::CreateMaybeMessage<::capability::v1::Capability>(Arena*);
template <>
::capability::v1::CapabilityOwners* Arena::CreateMaybeMessage<::capability::v1::CapabilityOwners>(Arena*);
template <>
::capability::v1::Owner* Arena::CreateMaybeMessage<::capability::v1::Owner>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
class Capability final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:capability.v1.Capability) */ {
 public:
  ...
  static ::absl::string_view FullMessageName() {
    return "capability.v1.Capability";
  }
  protected:
 ...
 private:
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_capability_2fv1_2fcapability_2eproto;
};// -------------------------------------------------------------------

class Owner final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:capability.v1.Owner) */ {
 public:
...
class CapabilityOwners final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:capability.v1.CapabilityOwners) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::absl::string_view FullMessageName() {
    return "capability.v1.CapabilityOwners";
  }
  protected:
  ...
  public:
  void clear_owners() ;
  ::capability::v1::Owner* mutable_owners(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::capability::v1::Owner >*
      mutable_owners();
  private:
  const ::capability::v1::Owner& _internal_owners(int index) const;
  ::capability::v1::Owner* _internal_add_owners();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::capability::v1::Owner>& _internal_owners() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::capability::v1::Owner>* _internal_mutable_owners();
  public:
  const ::capability::v1::Owner& owners(int index) const;
  ::capability::v1::Owner* add_owners();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::capability::v1::Owner >&
      owners() const;
 ...
 private:
  ...
  typedef void DestructorSkippable_;
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::capability::v1::Owner > owners_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_capability_2fv1_2fcapability_2eproto;
...
inline ::uint64_t Capability::index() const {
  // @@protoc_insertion_point(field_get:capability.v1.Capability.index)
  return _internal_index();
}
inline void Capability::set_index(::uint64_t value) {
  _internal_set_index(value);
  // @@protoc_insertion_point(field_set:capability.v1.Capability.index)
}
...
inline const std::string& Owner::module() const {
  // @@protoc_insertion_point(field_get:capability.v1.Owner.module)
...
inline PROTOBUF_ALWAYS_INLINE void Owner::set_module(Arg_&& arg,
  ...
  // @@protoc_insertion_point(field_set:capability.v1.Owner.module)
}
inline std::string* Owner::mutable_module() {
  std::string* _s = _internal_mutable_module();
  // @@protoc_insertion_point(field_mutable:capability.v1.Owner.module)
  return _s;
}
...
inline std::string* Owner::release_module() {
  // @@protoc_insertion_point(field_release:capability.v1.Owner.module)
...
inline void Owner::set_allocated_module(std::string* value) {
  ...
  // @@protoc_insertion_point(field_set_allocated:capability.v1.Owner.module)
}
...
inline const std::string& Owner::name() const {
  // @@protoc_insertion_point(field_get:capability.v1.Owner.name)
...
inline PROTOBUF_ALWAYS_INLINE void Owner::set_name(Arg_&& arg,
  ...
  // @@protoc_insertion_point(field_set:capability.v1.Owner.name)
}
inline std::string* Owner::mutable_name() {
  std::string* _s = _internal_mutable_name();
  // @@protoc_insertion_point(field_mutable:capability.v1.Owner.name)
  return _s;
}
...
inline std::string* Owner::release_name() {
  // @@protoc_insertion_point(field_release:capability.v1.Owner.name)
...
inline void Owner::set_allocated_name(std::string* value) {
  ...
  #endif  // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:capability.v1.Owner.name)
}
...
inline ::capability::v1::Owner* CapabilityOwners::mutable_owners(int index) {
  // @@protoc_insertion_point(field_mutable:capability.v1.CapabilityOwners.owners)
  return _internal_mutable_owners()->Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::capability::v1::Owner >*
CapabilityOwners::mutable_owners() {
  // @@protoc_insertion_point(field_mutable_list:capability.v1.CapabilityOwners.owners)
  return _internal_mutable_owners();
}
inline const ::capability::v1::Owner& CapabilityOwners::_internal_owners(int index) const {
  return _internal_owners().Get(index);
}
inline const ::capability::v1::Owner& CapabilityOwners::owners(int index) const {
  // @@protoc_insertion_point(field_get:capability.v1.CapabilityOwners.owners)
  return _internal_owners(index);
}
inline ::capability::v1::Owner* CapabilityOwners::_internal_add_owners() {
  return _internal_mutable_owners()->Add();
}
inline ::capability::v1::Owner* CapabilityOwners::add_owners() {
  ::capability::v1::Owner* _add = _internal_add_owners();
  // @@protoc_insertion_point(field_add:capability.v1.CapabilityOwners.owners)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::capability::v1::Owner >&
CapabilityOwners::owners() const {
  // @@protoc_insertion_point(field_list:capability.v1.CapabilityOwners.owners)
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_capability_2fv1_2fcapability_2eproto_2epb_2eh
