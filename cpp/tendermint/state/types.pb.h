...
#ifndef GOOGLE_PROTOBUF_INCLUDED_tendermint_2fstate_2ftypes_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_tendermint_2fstate_2ftypes_2eproto_2epb_2eh
...
PROTOBUF_NAMESPACE_OPEN
template <>
::tendermint::state::ABCIResponses* Arena::CreateMaybeMessage<::tendermint::state::ABCIResponses>(Arena*);
template <>
::tendermint::state::ABCIResponsesInfo* Arena::CreateMaybeMessage<::tendermint::state::ABCIResponsesInfo>(Arena*);
template <>
::tendermint::state::ConsensusParamsInfo* Arena::CreateMaybeMessage<::tendermint::state::ConsensusParamsInfo>(Arena*);
template <>
::tendermint::state::State* Arena::CreateMaybeMessage<::tendermint::state::State>(Arena*);
template <>
::tendermint::state::ValidatorsInfo* Arena::CreateMaybeMessage<::tendermint::state::ValidatorsInfo>(Arena*);
template <>
::tendermint::state::Version* Arena::CreateMaybeMessage<::tendermint::state::Version>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
class ABCIResponses final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR ABCIResponses(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void MergeFrom( const ABCIResponses& from) {
    ABCIResponses::MergeImpl(*this, from);
  }
  private:
  ...
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::tendermint::abci::ResponseDeliverTx>& _internal_deliver_txs() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::tendermint::abci::ResponseDeliverTx>* _internal_mutable_deliver_txs();
  public:
...
class ValidatorsInfo final :
 ...
 public:
  ...
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR ValidatorsInfo(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void MergeFrom( const ValidatorsInfo& from) {
    ValidatorsInfo::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
...
class ConsensusParamsInfo final :
 ...
 public:
  ...
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR ConsensusParamsInfo(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void MergeFrom( const ConsensusParamsInfo& from) {
    ConsensusParamsInfo::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
...
class ABCIResponsesInfo final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:tendermint.state.ABCIResponsesInfo) */ {
 public:
  inline ABCIResponsesInfo() : ABCIResponsesInfo(nullptr) {}
  ~ABCIResponsesInfo() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR ABCIResponsesInfo(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  ABCIResponsesInfo(const ABCIResponsesInfo& from);
  ABCIResponsesInfo(ABCIResponsesInfo&& from) noexcept
    : ABCIResponsesInfo() {
    *this = ::std::move(from);
  }

  inline ABCIResponsesInfo& operator=(const ABCIResponsesInfo& from) {
    CopyFrom(from);
    return *this;
  }
  inline ABCIResponsesInfo& operator=(ABCIResponsesInfo&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const ABCIResponsesInfo& default_instance() {
    return *internal_default_instance();
  }
  static inline const ABCIResponsesInfo* internal_default_instance() {
    return reinterpret_cast<const ABCIResponsesInfo*>(
               &_ABCIResponsesInfo_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    3;

  friend void swap(ABCIResponsesInfo& a, ABCIResponsesInfo& b) {
    a.Swap(&b);
  }
  inline void Swap(ABCIResponsesInfo* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(ABCIResponsesInfo* other) {
    if (other == this) return;
    ABSL_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  ABCIResponsesInfo* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<ABCIResponsesInfo>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const ABCIResponsesInfo& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const ABCIResponsesInfo& from) {
    ABCIResponsesInfo::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(ABCIResponsesInfo* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::absl::string_view FullMessageName() {
    return "tendermint.state.ABCIResponsesInfo";
  }
  protected:
  explicit ABCIResponsesInfo(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
  ...
  enum : int {
    kAbciResponsesFieldNumber = 1,
    kHeightFieldNumber = 2,
  };
  // .tendermint.state.ABCIResponses abci_responses = 1 [json_name = "abciResponses"];
  bool has_abci_responses() const;
  void clear_abci_responses() ;
  const ::tendermint::state::ABCIResponses& abci_responses() const;
  PROTOBUF_NODISCARD ::tendermint::state::ABCIResponses* release_abci_responses();
  ::tendermint::state::ABCIResponses* mutable_abci_responses();
  void set_allocated_abci_responses(::tendermint::state::ABCIResponses* abci_responses);
  private:
  const ::tendermint::state::ABCIResponses& _internal_abci_responses() const;
  ::tendermint::state::ABCIResponses* _internal_mutable_abci_responses();
  public:
  void unsafe_arena_set_allocated_abci_responses(
      ::tendermint::state::ABCIResponses* abci_responses);
  ::tendermint::state::ABCIResponses* unsafe_arena_release_abci_responses();
 ...
 private:
  ...
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::internal::HasBits<1> _has_bits_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
    ::tendermint::state::ABCIResponses* abci_responses_;
    ::int64_t height_;
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_tendermint_2fstate_2ftypes_2eproto;
...
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::tendermint::abci::ResponseDeliverTx>&
ABCIResponses::_internal_deliver_txs() const {
  return _impl_.deliver_txs_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::tendermint::abci::ResponseDeliverTx>*
ABCIResponses::_internal_mutable_deliver_txs() {
  return &_impl_.deliver_txs_;
}
...
inline bool ABCIResponses::has_end_block() const {
  ...
  PROTOBUF_ASSUME(!value || _impl_.end_block_ != nullptr);
  return value;
}
inline const ::tendermint::abci::ResponseEndBlock& ABCIResponses::_internal_end_block() const {
  const ::tendermint::abci::ResponseEndBlock* p = _impl_.end_block_;
...
inline void ABCIResponses::unsafe_arena_set_allocated_end_block(
  ...
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.end_block_);
  }
  _impl_.end_block_ = end_block;
  if (end_block) {
...
inline ::tendermint::abci::ResponseEndBlock* ABCIResponses::release_end_block() {
  _impl_._has_bits_[0] &= ~0x00000001u;
  ::tendermint::abci::ResponseEndBlock* temp = _impl_.end_block_;
  _impl_.end_block_ = nullptr;
...
inline bool ABCIResponses::has_begin_block() const {
  ...
  PROTOBUF_ASSUME(!value || _impl_.begin_block_ != nullptr);
  return value;
}
inline const ::tendermint::abci::ResponseBeginBlock& ABCIResponses::_internal_begin_block() const {
  const ::tendermint::abci::ResponseBeginBlock* p = _impl_.begin_block_;
...
inline void ABCIResponses::unsafe_arena_set_allocated_begin_block(
    ::tendermint::abci::ResponseBeginBlock* begin_block) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.begin_block_);
  }
  _impl_.begin_block_ = begin_block;
  if (begin_block) {
...
inline ::tendermint::abci::ResponseBeginBlock* ABCIResponses::release_begin_block() {
  _impl_._has_bits_[0] &= ~0x00000002u;
  ::tendermint::abci::ResponseBeginBlock* temp = _impl_.begin_block_;
  _impl_.begin_block_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  if (GetArenaForAllocation() == nullptr) { delete old; }
...
// .tendermint.state.ABCIResponses abci_responses = 1 [json_name = "abciResponses"];
inline bool ABCIResponsesInfo::has_abci_responses() const {
  bool value = (_impl_._has_bits_[0] & 0x00000001u) != 0;
  PROTOBUF_ASSUME(!value || _impl_.abci_responses_ != nullptr);
  return value;
}
inline void ABCIResponsesInfo::clear_abci_responses() {
  if (_impl_.abci_responses_ != nullptr) _impl_.abci_responses_->Clear();
  _impl_._has_bits_[0] &= ~0x00000001u;
}
inline const ::tendermint::state::ABCIResponses& ABCIResponsesInfo::_internal_abci_responses() const {
  const ::tendermint::state::ABCIResponses* p = _impl_.abci_responses_;
  return p != nullptr ? *p : reinterpret_cast<const ::tendermint::state::ABCIResponses&>(
      ::tendermint::state::_ABCIResponses_default_instance_);
}
inline const ::tendermint::state::ABCIResponses& ABCIResponsesInfo::abci_responses() const {
  // @@protoc_insertion_point(field_get:tendermint.state.ABCIResponsesInfo.abci_responses)
  return _internal_abci_responses();
}
inline void ABCIResponsesInfo::unsafe_arena_set_allocated_abci_responses(
    ::tendermint::state::ABCIResponses* abci_responses) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.abci_responses_);
  }
  _impl_.abci_responses_ = abci_responses;
  if (abci_responses) {
    _impl_._has_bits_[0] |= 0x00000001u;
  } else {
    _impl_._has_bits_[0] &= ~0x00000001u;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:tendermint.state.ABCIResponsesInfo.abci_responses)
}
inline ::tendermint::state::ABCIResponses* ABCIResponsesInfo::release_abci_responses() {
  _impl_._has_bits_[0] &= ~0x00000001u;
  ::tendermint::state::ABCIResponses* temp = _impl_.abci_responses_;
  _impl_.abci_responses_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  if (GetArenaForAllocation() == nullptr) { delete old; }
...
inline ::tendermint::state::ABCIResponses* ABCIResponsesInfo::unsafe_arena_release_abci_responses() {
  // @@protoc_insertion_point(field_release:tendermint.state.ABCIResponsesInfo.abci_responses)
  _impl_._has_bits_[0] &= ~0x00000001u;
  ::tendermint::state::ABCIResponses* temp = _impl_.abci_responses_;
  _impl_.abci_responses_ = nullptr;
  return temp;
}
inline ::tendermint::state::ABCIResponses* ABCIResponsesInfo::_internal_mutable_abci_responses() {
  _impl_._has_bits_[0] |= 0x00000001u;
  if (_impl_.abci_responses_ == nullptr) {
    auto* p = CreateMaybeMessage<::tendermint::state::ABCIResponses>(GetArenaForAllocation());
    _impl_.abci_responses_ = p;
  }
  return _impl_.abci_responses_;
}
inline ::tendermint::state::ABCIResponses* ABCIResponsesInfo::mutable_abci_responses() {
  ::tendermint::state::ABCIResponses* _msg = _internal_mutable_abci_responses();
  // @@protoc_insertion_point(field_mutable:tendermint.state.ABCIResponsesInfo.abci_responses)
  return _msg;
}
inline void ABCIResponsesInfo::set_allocated_abci_responses(::tendermint::state::ABCIResponses* abci_responses) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.abci_responses_;
  }
  if (abci_responses) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(abci_responses);
    if (message_arena != submessage_arena) {
      abci_responses = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, abci_responses, submessage_arena);
    }
    _impl_._has_bits_[0] |= 0x00000001u;
  } else {
    _impl_._has_bits_[0] &= ~0x00000001u;
  ...
  _impl_.abci_responses_ = abci_responses;
  // @@protoc_insertion_point(field_set_allocated:tendermint.state.ABCIResponsesInfo.abci_responses)
}

// int64 height = 2 [json_name = "height"];
inline void ABCIResponsesInfo::clear_height() {
  _impl_.height_ = ::int64_t{0};
}
inline ::int64_t ABCIResponsesInfo::height() const {
  // @@protoc_insertion_point(field_get:tendermint.state.ABCIResponsesInfo.height)
  return _internal_height();
}
inline void ABCIResponsesInfo::set_height(::int64_t value) {
  _internal_set_height(value);
  // @@protoc_insertion_point(field_set:tendermint.state.ABCIResponsesInfo.height)
}
inline ::int64_t ABCIResponsesInfo::_internal_height() const {
  return _impl_.height_;
}
inline void ABCIResponsesInfo::_internal_set_height(::int64_t value) {
  ;
...
inline const ::tendermint::version::Consensus& Version::_internal_consensus() const {
  const ::tendermint::version::Consensus* p = _impl_.consensus_;
...
inline void Version::unsafe_arena_set_allocated_consensus(
    ::tendermint::version::Consensus* consensus) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.consensus_);
  }
  _impl_.consensus_ = consensus;
  if (consensus) {
    _impl_._has_bits_[0] |= 0x00000001u;
  } else {
    _impl_._has_bits_[0] &= ~0x00000001u;
...
inline ::tendermint::version::Consensus* Version::release_consensus() {
  _impl_._has_bits_[0] &= ~0x00000001u;
  ::tendermint::version::Consensus* temp = _impl_.consensus_;
...
inline PROTOBUF_ALWAYS_INLINE void Version::set_software(Arg_&& arg,
                                                     Args_... args) {
  ;
...
inline void Version::set_allocated_software(std::string* value) {
...
inline const ::tendermint::state::Version& State::_internal_version() const {
  const ::tendermint::state::Version* p = _impl_.version_;
...
inline ::tendermint::state::Version* State::release_version() {
  _impl_._has_bits_[0] &= ~0x00000001u;
  ::tendermint::state::Version* temp = _impl_.version_;
...
template <typename Arg_, typename... Args_>
inline PROTOBUF_ALWAYS_INLINE void State::set_chain_id(Arg_&& arg,
                                                     Args_... args) {
  ;
...
inline void State::set_allocated_chain_id(std::string* value) {
...
inline bool State::has_last_block_time() const {
  ...
  PROTOBUF_ASSUME(!value || _impl_.last_block_time_ != nullptr);
  return value;
}
inline const ::PROTOBUF_NAMESPACE_ID::Timestamp& State::_internal_last_block_time() const {
  const ::PROTOBUF_NAMESPACE_ID::Timestamp* p = _impl_.last_block_time_;
...
inline void State::unsafe_arena_set_allocated_last_block_time(
    ::PROTOBUF_NAMESPACE_ID::Timestamp* last_block_time) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.last_block_time_);
  }
  _impl_.last_block_time_ = last_block_time;
  if (last_block_time) {
...
inline ::PROTOBUF_NAMESPACE_ID::Timestamp* State::release_last_block_time() {
  _impl_._has_bits_[0] &= ~0x00000004u;
  ::PROTOBUF_NAMESPACE_ID::Timestamp* temp = _impl_.last_block_time_;
  _impl_.last_block_time_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  if (GetArenaForAllocation() == nullptr) { delete old; }
...
inline ::PROTOBUF_NAMESPACE_ID::Timestamp* State::_internal_mutable_last_block_time() {
  _impl_._has_bits_[0] |= 0x00000004u;
  if (_impl_.last_block_time_ == nullptr) {
    auto* p = CreateMaybeMessage<::PROTOBUF_NAMESPACE_ID::Timestamp>(GetArenaForAllocation());
    _impl_.last_block_time_ = p;
  }
  return _impl_.last_block_time_;
}
...
inline bool State::has_next_validators() const {
  ...
  PROTOBUF_ASSUME(!value || _impl_.next_validators_ != nullptr);
  return value;
}
inline const ::tendermint::types::ValidatorSet& State::_internal_next_validators() const {
  const ::tendermint::types::ValidatorSet* p = _impl_.next_validators_;
  return p != nullptr ? *p : reinterpret_cast<const ::tendermint::types::ValidatorSet&>(
      ::tendermint::types::_ValidatorSet_default_instance_);
}
...
inline void State::unsafe_arena_set_allocated_next_validators(
    ::tendermint::types::ValidatorSet* next_validators) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.next_validators_);
  }
  _impl_.next_validators_ = next_validators;
  if (next_validators) {
...
inline ::tendermint::types::ValidatorSet* State::release_next_validators() {
  _impl_._has_bits_[0] &= ~0x00000008u;
  ::tendermint::types::ValidatorSet* temp = _impl_.next_validators_;
  _impl_.next_validators_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  if (GetArenaForAllocation() == nullptr) { delete old; }
...
inline ::tendermint::types::ValidatorSet* State::_internal_mutable_next_validators() {
  _impl_._has_bits_[0] |= 0x00000008u;
  if (_impl_.next_validators_ == nullptr) {
    auto* p = CreateMaybeMessage<::tendermint::types::ValidatorSet>(GetArenaForAllocation());
    _impl_.next_validators_ = p;
  }
  return _impl_.next_validators_;
}
...
inline bool State::has_validators() const {
  ...
  PROTOBUF_ASSUME(!value || _impl_.validators_ != nullptr);
  return value;
}
inline const ::tendermint::types::ValidatorSet& State::_internal_validators() const {
  const ::tendermint::types::ValidatorSet* p = _impl_.validators_;
  return p != nullptr ? *p : reinterpret_cast<const ::tendermint::types::ValidatorSet&>(
      ::tendermint::types::_ValidatorSet_default_instance_);
}
...
inline void State::unsafe_arena_set_allocated_validators(
    ::tendermint::types::ValidatorSet* validators) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.validators_);
  }
  _impl_.validators_ = validators;
  if (validators) {
...
inline ::tendermint::types::ValidatorSet* State::release_validators() {
  _impl_._has_bits_[0] &= ~0x00000010u;
  ::tendermint::types::ValidatorSet* temp = _impl_.validators_;
  _impl_.validators_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  if (GetArenaForAllocation() == nullptr) { delete old; }
...
inline ::tendermint::types::ValidatorSet* State::_internal_mutable_validators() {
  _impl_._has_bits_[0] |= 0x00000010u;
  if (_impl_.validators_ == nullptr) {
    auto* p = CreateMaybeMessage<::tendermint::types::ValidatorSet>(GetArenaForAllocation());
    _impl_.validators_ = p;
  }
...
inline bool State::has_last_validators() const {
  ...
  PROTOBUF_ASSUME(!value || _impl_.last_validators_ != nullptr);
  return value;
}
inline const ::tendermint::types::ValidatorSet& State::_internal_last_validators() const {
  const ::tendermint::types::ValidatorSet* p = _impl_.last_validators_;
  return p != nullptr ? *p : reinterpret_cast<const ::tendermint::types::ValidatorSet&>(
      ::tendermint::types::_ValidatorSet_default_instance_);
}
...
inline void State::unsafe_arena_set_allocated_last_validators(
    ::tendermint::types::ValidatorSet* last_validators) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.last_validators_);
  }
  _impl_.last_validators_ = last_validators;
  if (last_validators) {
...
inline ::tendermint::types::ValidatorSet* State::release_last_validators() {
  _impl_._has_bits_[0] &= ~0x00000020u;
  ::tendermint::types::ValidatorSet* temp = _impl_.last_validators_;
  _impl_.last_validators_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  if (GetArenaForAllocation() == nullptr) { delete old; }
...
inline ::tendermint::types::ValidatorSet* State::_internal_mutable_last_validators() {
  _impl_._has_bits_[0] |= 0x00000020u;
  if (_impl_.last_validators_ == nullptr) {
    auto* p = CreateMaybeMessage<::tendermint::types::ValidatorSet>(GetArenaForAllocation());
    _impl_.last_validators_ = p;
  }
  return _impl_.last_validators_;
}
...
inline void State::clear_last_height_validators_changed() {
  _impl_.last_height_validators_changed_ = ::int64_t{0};
}
...
inline ::int64_t State::_internal_last_height_validators_changed() const {
  return _impl_.last_height_validators_changed_;
}
inline void State::_internal_set_last_height_validators_changed(::int64_t value) {
  ;
  _impl_.last_height_validators_changed_ = value;
}
...
inline void State::clear_last_height_consensus_params_changed() {
  _impl_.last_height_consensus_params_changed_ = ::int64_t{0};
}
...
inline ::int64_t State::_internal_last_height_consensus_params_changed() const {
  return _impl_.last_height_consensus_params_changed_;
}
inline void State::_internal_set_last_height_consensus_params_changed(::int64_t value) {
  ;
  _impl_.last_height_consensus_params_changed_ = value;
}
...
template <typename Arg_, typename... Args_>
inline PROTOBUF_ALWAYS_INLINE void State::set_last_results_hash(Arg_&& arg,
                                                     Args_... args) {
  ;
...
inline void State::set_allocated_last_results_hash(std::string* value) {
...
template <typename Arg_, typename... Args_>
inline PROTOBUF_ALWAYS_INLINE void State::set_app_hash(Arg_&& arg,
                                                     Args_... args) {
  ;
...
inline void State::set_allocated_app_hash(std::string* value) {
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_tendermint_2fstate_2ftypes_2eproto_2epb_2eh
