...
PROTOBUF_NAMESPACE_OPEN
template <>
::cosmos::feegrant::v1beta1::GenesisState* Arena::CreateMaybeMessage<::cosmos::feegrant::v1beta1::GenesisState>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
class GenesisState final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:cosmos.feegrant.v1beta1.GenesisState) */ {
 public:
...
inline const ::cosmos::feegrant::v1beta1::Grant& GenesisState::_internal_allowances(int index) const {
...
inline ::cosmos::feegrant::v1beta1::Grant* GenesisState::_internal_add_allowances() {
