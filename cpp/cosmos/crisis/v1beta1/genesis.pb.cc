...
static ::_pb::Metadata file_level_metadata_cosmos_2fcrisis_2fv1beta1_2fgenesis_2eproto[1];
...
const ::uint32_t TableStruct_cosmos_2fcrisis_2fv1beta1_2fgenesis_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
    protodesc_cold) = {
...
const char descriptor_table_protodef_cosmos_2fcrisis_2fv1beta1_2fgenesis_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
...
const ::_pbi::DescriptorTable descriptor_table_cosmos_2fcrisis_2fv1beta1_2fgenesis_2eproto = {
    false,
    false,
    437,
    ...
    file_level_metadata_cosmos_2fcrisis_2fv1beta1_2fgenesis_2eproto,
...
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_cosmos_2fcrisis_2fv1beta1_2fgenesis_2eproto_getter() {
  return &descriptor_table_cosmos_2fcrisis_2fv1beta1_2fgenesis_2eproto;
}
// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2
static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_cosmos_2fcrisis_2fv1beta1_2fgenesis_2eproto(&descriptor_table_cosmos_2fcrisis_2fv1beta1_2fgenesis_2eproto);
namespace cosmos {
namespace crisis {
namespace v1beta1 {
// ===================================================================
...
class GenesisState::_Internal {
 public:
  ...
  static const ::cosmos::base::v1beta1::Coin& constant_fee(const GenesisState* msg);
...
GenesisState::_Internal::constant_fee(const GenesisState* msg) {
...
::uint8_t* GenesisState::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000001u) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(3, _Internal::constant_fee(this),
...
::PROTOBUF_NAMESPACE_ID::Metadata GenesisState::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_cosmos_2fcrisis_2fv1beta1_2fgenesis_2eproto_getter, &descriptor_table_cosmos_2fcrisis_2fv1beta1_2fgenesis_2eproto_once,
      file_level_metadata_cosmos_2fcrisis_2fv1beta1_2fgenesis_2eproto[0]);
}
...
template<> PROTOBUF_NOINLINE ::cosmos::crisis::v1beta1::GenesisState*
Arena::CreateMaybeMessage< ::cosmos::crisis::v1beta1::GenesisState >(Arena* arena) {
  return Arena::CreateMessageInternal< ::cosmos::crisis::v1beta1::GenesisState >(arena);
}
