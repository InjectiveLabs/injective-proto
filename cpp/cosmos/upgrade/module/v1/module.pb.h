...
PROTOBUF_NAMESPACE_OPEN
template <>
::cosmos::upgrade::module::v1::Module* Arena::CreateMaybeMessage<::cosmos::upgrade::module::v1::Module>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
class Module final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:cosmos.upgrade.module.v1.Module) */ {
 public:
