    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::uint8_t>(tag) == 10)) {
          ...
          do {
            ptr += 1;
            auto str = _internal_add_hooks_order();
            ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
            CHK_(ptr);
            CHK_(::_pbi::VerifyUTF8(str, "cosmos.staking.module.v1.Module.hooks_order"));
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::uint8_t>(tag) == 18)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "cosmos.staking.module.v1.Module.authority"));
        } else {
          goto handle_unusual;
        }
        continue;
...
::uint8_t* Module::_InternalSerialize(
  ...
  for (int i = 0, n = this->_internal_hooks_order_size(); i < n; ++i) {
    const auto& s = this->_internal_hooks_order(i);
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
        s.data(), static_cast<int>(s.length()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE, "cosmos.staking.module.v1.Module.hooks_order");
  ...
  if (!this->_internal_authority().empty()) {
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE, "cosmos.staking.module.v1.Module.authority");
...
// @@protoc_insertion_point(message_byte_size_start:cosmos.staking.module.v1.Module)
  ...
  // repeated string hooks_order = 1 [json_name = "hooksOrder"];
  total_size += 1 * ::PROTOBUF_NAMESPACE_ID::internal::FromIntSize(_internal_hooks_order().size());
...
void Module::InternalSwap(Module* other) {
  ...
  _internal_mutable_hooks_order()->InternalSwap(
      other->_internal_mutable_hooks_order());
...
template<> PROTOBUF_NOINLINE ::cosmos::staking::module::v1::Module*
Arena::CreateMaybeMessage< ::cosmos::staking::module::v1::Module >(Arena* arena) {
  return Arena::CreateMessageInternal< ::cosmos::staking::module::v1::Module >(arena);
}
