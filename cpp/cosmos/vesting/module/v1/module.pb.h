...
PROTOBUF_NAMESPACE_OPEN
template <>
::cosmos::vesting::module::v1::Module* Arena::CreateMaybeMessage<::cosmos::vesting::module::v1::Module>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
class Module final :
    public ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase /* @@protoc_insertion_point(class_definition:cosmos.vesting.module.v1.Module) */ {
 public:
