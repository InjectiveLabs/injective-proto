...
PROTOBUF_NAMESPACE_OPEN
template <>
::cosmos::crypto::secp256k1::PrivKey* Arena::CreateMaybeMessage<::cosmos::crypto::secp256k1::PrivKey>(Arena*);
template <>
::cosmos::crypto::secp256k1::PubKey* Arena::CreateMaybeMessage<::cosmos::crypto::secp256k1::PubKey>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
class PrivKey final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:cosmos.crypto.secp256k1.PrivKey) */ {
 public:
