...
PROTOBUF_NAMESPACE_OPEN
template <>
::cosmos::crypto::ed25519::PrivKey* Arena::CreateMaybeMessage<::cosmos::crypto::ed25519::PrivKey>(Arena*);
template <>
::cosmos::crypto::ed25519::PubKey* Arena::CreateMaybeMessage<::cosmos::crypto::ed25519::PubKey>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
class PubKey final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:cosmos.crypto.ed25519.PubKey) */ {
 public:
...
class PrivKey final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:cosmos.crypto.ed25519.PrivKey) */ {
 public:
