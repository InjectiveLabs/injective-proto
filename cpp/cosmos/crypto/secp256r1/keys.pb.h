...
PROTOBUF_NAMESPACE_OPEN
template <>
::cosmos::crypto::secp256r1::PrivKey* Arena::CreateMaybeMessage<::cosmos::crypto::secp256r1::PrivKey>(Arena*);
template <>
::cosmos::crypto::secp256r1::PubKey* Arena::CreateMaybeMessage<::cosmos::crypto::secp256r1::PubKey>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
class PubKey final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:cosmos.crypto.secp256r1.PubKey) */ {
 public:
...
class PrivKey final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:cosmos.crypto.secp256r1.PrivKey) */ {
 public:
