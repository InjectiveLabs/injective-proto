...
PROTOBUF_NAMESPACE_OPEN
template <>
::cosmos::crypto::hd::v1::BIP44Params* Arena::CreateMaybeMessage<::cosmos::crypto::hd::v1::BIP44Params>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
class BIP44Params final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:cosmos.crypto.hd.v1.BIP44Params) */ {
 public:
  inline BIP44Params() : BIP44Params(nullptr) {}
  ~BIP44Params() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR BIP44Params(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  BIP44Params* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  protected:
  explicit BIP44Params(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
