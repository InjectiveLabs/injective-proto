...
PROTOBUF_NAMESPACE_OPEN
template <>
::cosmos::authz::module::v1::Module* Arena::CreateMaybeMessage<::cosmos::authz::module::v1::Module>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
class Module final :
    public ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase /* @@protoc_insertion_point(class_definition:cosmos.authz.module.v1.Module) */ {
 public:
