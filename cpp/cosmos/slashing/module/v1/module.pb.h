...
PROTOBUF_NAMESPACE_OPEN
template <>
::cosmos::slashing::module::v1::Module* Arena::CreateMaybeMessage<::cosmos::slashing::module::v1::Module>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
class Module final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:cosmos.slashing.module.v1.Module) */ {
 public:
