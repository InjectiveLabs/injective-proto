...
template<> PROTOBUF_NOINLINE ::cosmos::gov::v1beta1::GenesisState*
Arena::CreateMaybeMessage< ::cosmos::gov::v1beta1::GenesisState >(Arena* arena) {
  return Arena::CreateMessageInternal< ::cosmos::gov::v1beta1::GenesisState >(arena);
}
