...
PROTOBUF_NAMESPACE_OPEN
template <>
::cosmos::gov::v1beta1::GenesisState* Arena::CreateMaybeMessage<::cosmos::gov::v1beta1::GenesisState>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
class GenesisState final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:cosmos.gov.v1beta1.GenesisState) */ {
 public:
...
inline const ::cosmos::gov::v1beta1::Deposit& GenesisState::_internal_deposits(int index) const {
...
inline ::cosmos::gov::v1beta1::Deposit* GenesisState::_internal_add_deposits() {
...
inline const ::cosmos::gov::v1beta1::Vote& GenesisState::_internal_votes(int index) const {
...
inline ::cosmos::gov::v1beta1::Vote* GenesisState::_internal_add_votes() {
...
inline const ::cosmos::gov::v1beta1::Proposal& GenesisState::_internal_proposals(int index) const {
...
inline ::cosmos::gov::v1beta1::Proposal* GenesisState::_internal_add_proposals() {
...
inline void GenesisState::set_allocated_deposit_params(::cosmos::gov::v1beta1::DepositParams* deposit_params) {
...
inline void GenesisState::set_allocated_voting_params(::cosmos::gov::v1beta1::VotingParams* voting_params) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.voting_params_);
  }
...
inline void GenesisState::set_allocated_tally_params(::cosmos::gov::v1beta1::TallyParams* tally_params) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.tally_params_);
  }
