...
PROTOBUF_NAMESPACE_OPEN
template <>
::cosmos::mint::v1beta1::MsgUpdateParams* Arena::CreateMaybeMessage<::cosmos::mint::v1beta1::MsgUpdateParams>(Arena*);
template <>
::cosmos::mint::v1beta1::MsgUpdateParamsResponse* Arena::CreateMaybeMessage<::cosmos::mint::v1beta1::MsgUpdateParamsResponse>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
class MsgUpdateParams final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:cosmos.mint.v1beta1.MsgUpdateParams) */ {
 public:
...
class MsgUpdateParamsResponse final :
    public ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase /* @@protoc_insertion_point(class_definition:cosmos.mint.v1beta1.MsgUpdateParamsResponse) */ {
 public:
...
inline void MsgUpdateParams::set_allocated_params(::cosmos::mint::v1beta1::Params* params) {
